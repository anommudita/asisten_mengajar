                ...
                <div class="container-fluid">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- Page Heading -->
                            <h1 class="h3 mb-2 text-gray-800 mt-2 mb-3">Edit <?=$galeri;?></h1>
                            <!-- DataTales Example -->
                            <div class="card shadow mb-4 p-4 col-12 col-lg-8">
                            <?=form_open_multipart('admin/edit_galeri/'.$galeri1['id']) ?>
                                    <!-- nama kegiatan -->
                                    <div class="form-group">
                                        <label for="judul">Judul</label>
                                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukan judul" value="<?=$galeri1['judul']?>">
                                        <!-- notif error -->
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-3 pl-1">
                                                    <img src="<?= base_url('assets') ?>/img/galeri/<?=$galeri1['gambar']?>" alt="image1" class="img-thumbnail">
                                                </div>
