                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4 p-4 col-12 col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" placeholder="Masukan judul kegiatan">
                                    <!-- notif error -->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="content" name="content" placeholder="Masukan deskripsi kegiatan" rows="10"></textarea>
                                    <!-- notif error -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-3 pl-1">
                                                <img src="<?= base_url('assets') ?>/img/logoundiksha.png" alt="image2" class="img-thumbnail">
                                            </div>
                                            <div class="col-sm-9 pr-1">
                                                <div class="custom-file">
